...
public:
    explicit MinimalActionClient(const rclcpp::NodeOptions &node_options = rclcpp::NodeOptions())
        : Node("minimal_action", node_options)
    {
    ...
    void send_goal(int64_t num)
    {
        ...
        send_goal_options.feedback_callback =
            std::bind(&MinimalActionClient::feed_backcall, this, _1, _2);
...
private:
    ...
    // 处理连续反馈
    void feed_backcall(GoalHandleProgress::SharedPtr goal_handle, const std::shared_ptr<const Progress::Feedback> feedback)
    {
